...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Avneet Singh',", type: 'array-item' },
    { code: "    role: 'CSE Student @ University of Toledo',", type: 'array-item' },
    { code: "    bio: '// Still debugging life… but the code runs fine.'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
    ...
    { code: '        <a href="/resume.pdf" download>Download Resume</a>', type: 'object-method' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Avneet <span className={styles.accentText}>Singh</span>
          </h1>
